...
export const PromotionModal: React.FC<PromotionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-200 select-none">
      <div className="w-full max-w-md bg-[#16202E] border border-[#334155] rounded-3xl p-6 shadow-2xl text-center flex flex-col items-center">
        {/* Icon & Tiêu đề */}
        ...
        <div className="grid grid-cols-2 gap-3 w-full mb-5">
          {pieces.map((piece) => (
            ...
            >
              ...
              <span className="text-[10px] text-[#94A3B8] mt-0.5">{piece.sub}</span>
            </button>
          ))}
        </div>
