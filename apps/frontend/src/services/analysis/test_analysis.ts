...
console.log('🏁 --- BẮT ĐẦU CHẠY KIỂM THỬ MODULE PHÂN TÍCH VÁN ĐẤU (CỘT TRỤ 2) ---');

const report = AnalysisEngine.analyzeGame(
  sampleGameScholar,
  sampleTelemetries,
  'match_test_001',
  2 // Depth 2
...
console.log('\n🧠 3. VECTOR ĐẶC TRƯNG HỒ SƠ KỲ THỦ (FEATURE VECTOR CHO K-MEANS Ở CỘT TRỤ 3):');
